	...
	g.onload=function(){
		...
		;(function(){
			...
			g.PageTurn=function(id,n){
				...
				var _this=this;
				this.oPageBox.onclick=function(){
					_this.nextClick();
				};			
			};
		...
		;(function(){
			g.Cubic=function(id,R,C,n){
				...
				var _this=this;
				this.oCubicBox.onclick=function(){
					_this.nextClick();
				};			
			};
		...
		;(function(){
			...
			Circle.prototype.mouseControl=function(){
				...
				document.onmousedown=function(ev){
					...
					var disX=ev.clientX-_this.y;
					document.onmousemove=function(ev){
						_this.y=ev.clientX-disX;
						_this.change();
						_this.iSpeedY=ev.clientX-_this.lastY;//实时的获取速度，以便松手的时候有值
						_this.lastY=ev.clientX;
					};
